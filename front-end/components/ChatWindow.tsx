      ...
      >
        {messages.length === 0 ? (
          ...
          messages.map((m) => {
            ...
            const isImage = m.body?.type === "image";  // ✅ check body type
              ...
              >
                <div style={{
                  ...
                  {isImage ? (
                    <div>
                      <img
                        src={m.body.image.link}
                        alt={m.body.image.caption || "image"}
                        style={{
                          width: "100%",
                          maxWidth: 220,
                          borderRadius: 8,
                  ...
                  <div style={{
                    marginTop: 2, fontSize: 11, textAlign: "right",
